...
/**
 * sub_handler - tasked with handling sub instruction.
...
/**
 * div_handler - handling div instruction
 * @stack: double pointer to the stack that is supposed to be pushed to.
...
/**
 * mul_handler - handling the mul instruction
 * @stack: this is the double pointer to the stack that is supposed to be pushed to.
 * @line_number: line number in the file
 */
...
/**
 * mod_handler -  handling the mod instruction.
